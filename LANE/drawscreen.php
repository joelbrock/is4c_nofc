...
// -----------------------------------------------------------------------------------------------
	...
	echo "<tr><td width=119 bgcolor=white align=left><font face=arial color=black size=-1><center><b>".$strpercentdisclabel."</b></center></font></td>";
	echo "<td width=117 bgcolor=white align=center><font face=arial color=black size=-1><center><b>".$patronagelabel."</b></center></font></td>";
//	echo "<td width=117 bgcolor=white align=center><font face=arial color=black size=-1><b>Mbr Special</b></font></td>";
...
// ----------------------First Row Labels ---------------------------------------------------------
	...
	echo "<td width=117 bgcolor=white align=center><font face=arial color=# size=-1><b>";
	echo $strdiscountlabel."</b></font></td>";
	echo "<td width=117 bgcolor=white align=center></td>";
	...
	if ( $_SESSION["ttlflag"] == 1  and $_SESSION["End"] != 1 ) {
		if ($_SESSION["fntlflag"] == 1) {
			...
			echo "<td width=170 bgcolor=#CC0000 align=right><font face=arial color=white size=-1><b>Amount Due</b></font></td></tr>";
		}
	}
	elseif ($_SESSION["ttlflag"] == 1  and $_SESSION["End"] == 1 ) {
		echo "<td width=170 bgcolor=# align=right><font face=arial color=white size=-1><b>Change</b></font></td></tr>";
	}	
	else {
		echo "<td width=170 bgcolor='#96C8ED' align=right><font face=arial color=white size=-1><b>T O T A L</b></font></td></tr>";
	}
...
// -----------------------------------------------------------------
	...
	if (($_SESSION["trackPatronage"] == 1) || ($_SESSION["togglePatronage"] == 1)) {
		$patronagetotal = $_SESSION["patronageTotal"];
	} else {
		$patronagetotal = "0";
	}

	echo "<TR><TD height='2' colspan='5'></TD></TR>";
	echo "<TR><TD width='119' height='60' align='left'><FONT face='arial' size='+1' color='#333333'><CENTER>";
	echo number_format($strperdiscount, 2)."</CENTER></FONT></TD>";
	echo "<TD width='117' align='center' bgcolor='#EEEEEE'><FONT face='arial' color='#333333' size='+2'><CENTER><B>";
	echo number_format($patronagetotal, 2)."</B></CENTER></FONT></TD>";
	//echo "<TD width='117' align='center'><FONT face='arial' color='#808080' size='+1'>".number_format($strmemSpecial, 2)."</FONT></TD>";
	echo "<TD width='117' height='60' align='center'><FONT face='arial' color='#333333' size='+1'>".number_format($dbldiscounttotal, 2)."</FONT></TD>";
	echo "<TD width='117' height='60' align='center'></TD>";


	if ($_SESSION["ttlflag"] == 1 && $_SESSION["End"] != 1) {

		if ($_SESSION["fntlflag"] == 1) {
			echo "<TD width='170' height='60' align='center' bgcolor='white'><FONT face='arial' size='+4' color='#800080'><B>".number_format($_SESSION["fsEligible"], 2)."</B></FONT>";
			// $_SESSION["fntlflag"] = 0;
		} else {	
			echo "<TD width='170' height='60' align='center' bgcolor='white'><FONT face='arial' size='+4' color='#CC0000'><B>".number_format($_SESSION["runningTotal"], 2)."</B></FONT>";
		}
	}
	elseif ($_SESSION["ttlflag"] == 1 && $_SESSION["End"] == 1) {
		echo "<TD width= '170' height='60' align='center' bgcolor='white'><FONT face='arial' size='+4' color='#96C8ED'><B>".number_format($_SESSION["runningTotal"], 2)."</B></FONT>";
	}
	else {
		echo "<TD width='170' height='60' align='center'><FONT face='arial' size='+4'><B>".number_format($_SESSION["runningTotal"], 2)."</B></FONT>";
	}
...
echo "<FONT face='arial' size='+2' color='#96C8ED'><B>".$strmsg."</B></FONT></CENTER></TD></TR>";
...
function msgbox($strmsg, $icon) {
	...
	echo "<TR><TD colspan='5' bgcolor='#96C8ED' height='30' width='260' valign='center'>&nbsp;&nbsp;&nbsp;<FONT size='+1' face='arial' color='white'><B>".$_SESSION["alertBar"]."</B></FONT></TD></TR>";
...
echo "<TR>";
echo "<TD width='350'><FONT color='#96C8ED' face='arial' size='+1'>".$field2."</FONT></TD>";
...
echo "<TR><TD height='295' width='640' valign='center' align='center' colspan='3'></CENTER>";
echo "<FONT face='arial' size='+2' color='#96C8ED'><B>".$strmsg."<FORM action='/search.php' method='post' name='searchform'>";
...
echo "<TR><TD height='295' width='640' align='center' valign='center'>";
echo "<TABLE border='0' cellpadding='0' cellspacing='0'>";
echo "<TD bgcolor='#96C8ED' height='150' width='260' valign='center' align='center'><CENTER>";
...
echo "<TR><TD height='295' width='640' align='center' valign='center'>";
echo "<TABLE border='0' cellpadding='0' cellspacing='0'>";
echo "<TR><TD bgcolor='#96C8ED' height='150' width='260' valign='center' align='center'></CENTER>";
