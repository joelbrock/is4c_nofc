...
<?
		...
		echo "<INPUT name='reginput' Type=".$inputType." style='font-size:19px' value='' onBlur='document.form.reginput.focus();'>"
?>
			</FORM></TD>
...
if ($_SESSION["training"] == 1) {
	echo "<FONT size='-1' face='arial' color='#96C8ED'>training </FONT>"
