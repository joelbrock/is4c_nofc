...
<body style='background-color: #ffffff; color: #96C8ED' onload='document.forms[0].elements[0].focus();'>
...
if (!pinghost($_SESSION["memServer"])){
	...
	if (strlen($memNum)==6){
		...
		for ($i = 0; $i < $num_rows; $i++ ){
			...
			echo "<caption style='background-color: #96C8ED; color: #ffffff; font-weight: bold; text-align: left;'>".$sign." ".$row['2']." ".$row['1']." (".$memNum.")</caption>";
			if ($row['13']==0){
