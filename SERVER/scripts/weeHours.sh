...
mysqldump -uroot -peng@ge is4c_op custdata products | mysql -u root -h 192.168.123.101 opdata
...
mysqldump -uroot -peng@ge is4c_op custdata products | mysql -u root -h 192.168.123.102 opdata
...
mysqldump -uroot -peng@ge is4c_op custdata products | mysql -u root -h 192.168.123.103 opdata
