	...
	<table>
		...
		<tr>
			<td>&nbsp;
				...
				<option value=4>Local Program</option>
				</select>
			</td>
			<td><input type=text name=batchName></td>
			<td><p><input type="text" name="startDate" class="datepicker" size="10" /></p></td>
			<td><p><input type="text" name="endDate" class="datepicker" size="10" /></p></td>
